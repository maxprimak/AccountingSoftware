                        ...
                        <div class="p-4">
                            ...
                            @csrf
                                <div class="form-group">
                                    ...
                                    <input id="email" type="email" class="form-control-rounded form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" required>
                                    @if ($errors->has('email'))
                                    <p class="help-block">{{ $errors->first('email') }}</p>
                                    @endif
                                </div>
                                <button type="submit" class="btn btn-primary btn-block btn-rounded mt-3">{{ __('Send Password Reset Link') }}</button>
                            </form>
