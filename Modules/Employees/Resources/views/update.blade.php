<form action="{{ url('employees/'.$e->id) }}" method="POST">
    ...
    {{method_field('PATCH') }}
        <div class="form-group">
            ...
            <input name="new_full_name" id="username" class="form-control form-control-rounded" type="text" value="{{ $e->name }}">
        </div>
        <div class="form-group">
            <label for="password">new_username</label>
            <input name="new_username" id="password" class="form-control form-control-rounded" type="text" value="{{ $e->username }}">
        </div>
        ...
        <div class="form-group">
            ...
            <input name="new_email" id="password" class="form-control form-control-rounded" type="text" value="{{ $e->email }}">
        </div>
        <div class="form-group">
            <label for="password">new_phone</label>
            <input name="new_phone" id="password" class="form-control form-control-rounded" type="text" value="{{ $e->phone }}">
        </div>
        <div class="form-group">
