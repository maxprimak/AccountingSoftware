...
abstract class TestCase extends BaseTestCase
{
    ...
    public static function setUpEnvironment()
    {
        ...
        if (OrderStatus::all()->count() == 0) {
            ...
            $part = self::createPart('DefaultPart');
            self::createDefaultService('DefaultService1', $part->id);
            self::createDefaultService('DefaultService2', $part->id);
            self::createDefaultService('DefaultService3', $part->id);
